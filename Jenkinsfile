pipeline {
  ...
  tools {
    ...
    gradle 'Gradle6.7.1_Centos' //Preinstalada en la Configuración del Master
  }
  ...
  post {
    ...
    failure {
      ...
      mail(to: 'daniel.parra@ceiba.com.co', subject: "Failed Pipeline:${currentBuild.fullDisplayName}", body: "Something is wrong with ${env.BUILD_URL}")
    }
    unstable {
